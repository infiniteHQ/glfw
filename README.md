IMPORTANT : This is a fork of the original GLFW project. This project can compile with CMake for the Vortex creation platform render system.
Original GLFW repository : https://github.com/glfw/glfw
